...
The pipeline applies Boosting algorithms to predict whether a patient has heart disease based on clinical features.
...
| `target_column`      | `DataConfig`  | `'target'`   | Name of target outcome class column              |
