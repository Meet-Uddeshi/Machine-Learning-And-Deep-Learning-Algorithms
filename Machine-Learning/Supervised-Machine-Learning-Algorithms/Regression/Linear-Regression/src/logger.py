# ============================================================================
# Logging Module for Linear Regression Pipeline
# ============================================================================
# Provides a factory class to create and configure logger instances.
# Supports both console output and log-to-file capabilities in the output directory.
# ============================================================================
...
class LoggerFactory:
    ...
    Encapsulates all handler and formatter setup so that consumers simply call
    ...
    def create(
        ...
        # --- File handler (active if configured) ---
