...
class DataLoaderService:
    """Service responsible for loading, validating, downsampling, and preprocessing the dataset.
    ...
    def __init__(
        ...
        Args:
            path_config: Path settings for locating the dataset CSV.
            data_config: Data settings for target column, dropped columns, and split parameters.
    ...
    def load_and_prepare(
        ...
        """Execute the complete data pipeline: load -> validate -> downsample -> preprocess -> split.
        ...
        Raises:
            ...
            KeyError:          If configured columns are missing from the schema.
            ValueError:        If dataset is empty after reading.
        """
    ...
    def _load_csv(self) -> pd.DataFrame:
        """Read CSV file and check for non-empty dataframe."""
        self._logger.info(
    ...
    def _validate_schema(self, dataframe: pd.DataFrame) -> None:
        """Validate presence of target and drop columns in dataframe."""
    ...
    def _log_data_summary(self, dataframe: pd.DataFrame) -> None:
        """Log summary of columns, nulls, and target class counts."""
    ...
    def _preprocess(
        ...
        """Preprocess raw DataFrame into feature matrix and target vector."""
