# ============================================================================
# Configuration Module for SVM Classification Pipeline
# ============================================================================
...
class PathConfig:
    ...
    Attributes:
        project_root: Absolute path to the SVM project directory.
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            self,
            "dataset_file",
            os.path.join(self.project_root, "data", "iris.csv"),
        )
...
class DataConfig:
    ...
    Attributes:
        ...
        scale_features: Whether to apply StandardScaler on features (crucial for SVM).
    """
...
@dataclass(frozen=True)
class ModelConfig:
    """Hyperparameters for the Support Vector Machine (SVM) classifier.

    Attributes:
        C:              Regularization parameter (positive float). Penalty of error term.
        kernel:         Specifies the kernel type ('linear', 'poly', 'rbf', 'sigmoid').
        degree:         Degree of polynomial kernel ('poly'). Ignored by other kernels.
...
class PipelineConfig:
    ...
    Usage:
        ...
        config = PipelineConfig(model=ModelConfig(kernel='linear'))
    """
