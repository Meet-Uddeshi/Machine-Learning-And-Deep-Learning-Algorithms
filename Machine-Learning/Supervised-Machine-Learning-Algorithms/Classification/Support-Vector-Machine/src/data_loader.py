# ============================================================================
# Data Loader Module for Support Vector Machine Classification Pipeline
# ============================================================================
...
class DataLoaderService:
    ...
    Responsibilities:
        ...
        3. Encode categorical features and scale numeric features via StandardScaler.
    ...
    def __init__(
        ...
        # Populated during preprocessing and exposed via properties
    ...
    def load_and_prepare(
        ...
        # Downsample early if max_samples is set for fast iteration
    ...
    def _preprocess(
        ...
        Steps:
            ...
            6. Standardize all features (zero mean, unit variance) because
               SVM uses dot products/distances between support vectors.
        ...
        # SVM decision boundaries depend heavily on margin distance calculations.
        # Unscaled features would dominate the optimization objective.
