# ============================================================================
# Data Loader Module for Clustering Pipeline
# ============================================================================
# Handles all data I/O, validation, exploration, preprocessing, and scaling.
...
class DataLoaderService:
    ...
    Responsibilities:
        ...
        2. Log an exploratory summary (shape, nulls, class distribution of outcome).
        3. Drop non-predictive columns.
        4. Split into train/test sets with optional stratification on Outcome.
        5. Apply standardisation scaling (highly critical for distance-based clustering).
    """
    ...
    def label_names(self) -> list:
        """Ordered class labels of the outcome variable (for post-clustering check)."""
    ...
    def load_and_prepare(
        ...
        Returns:
            ...
            Where features are standardised and targets represent raw outcomes.
        """
        ...
        # Apply scaling if configured (highly recommended for clustering)
        if self._data_config.scale_features:
            self._logger.info("Feature scaling is activated (StandardScaler).")
    ...
    def _log_data_summary(self, dataframe: pd.DataFrame) -> None:
        ...
        self._logger.info("-" * 70)
        self._logger.info(
            "TARGET OUTCOME DISTRIBUTION ('%s'):", self._data_config.target_column
        )
    ...
    def _preprocess(
        ...
        """Transform raw data into feature matrices and target vectors.
        ...
        self._logger.info("Dropped columns (excluded from features): %s", drop_cols)
        ...
        # Encode target labels (used for verification metrics only)
        ...
        self._logger.info("Outcome categories resolved: %s", self._label_names)
        ...
        self._logger.info("Final clustering feature columns: %s", self._feature_names)
