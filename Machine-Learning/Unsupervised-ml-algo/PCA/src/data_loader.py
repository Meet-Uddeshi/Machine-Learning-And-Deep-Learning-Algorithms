# ============================================================================
# Data Loader Module for PCA Pipeline
# ============================================================================
# Handles all data I/O, validation, exploration, null value median imputation,
# label encoding, and feature standardisation using StandardScaler.
# ============================================================================
...
class DataLoaderService:
    ...
    Responsibilities:
        ...
        2. Log an exploratory summary (shape, nulls, target class distribution).
        3. Impute null values using column-wise median for numeric features.
        4. Separate target class (used for visualisation/validation).
        5. Split into train/test sets with optional stratification.
        6. Apply standardisation scaling (StandardScaler).
    """
    ...
    def label_names(self) -> list:
        """Ordered class labels of the target variable."""
    ...
    def load_and_prepare(
        ...
        Returns:
            ...
            Where features are standardised and targets represent vehicle classes.
        """
        ...
        # Apply scaling if configured (highly recommended for PCA)
    ...
    def _preprocess(
        ...
        self._logger.info("Target categories resolved: %s", self._label_names)
